defmodule Bookbump.Presence do
  @moduledoc """
  ...
  Presences can be tracked in your channel after joining:
      ...
      defmodule Bookbump.MyChannel do
        use Bookbump.Web, :channel
        alias Bookbump.Presence
  ...
  """
  use Phoenix.Presence, otp_app: :bookbump,
                        pubsub_server: Bookbump.PubSub
end
